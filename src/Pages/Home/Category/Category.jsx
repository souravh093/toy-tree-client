...
const Category = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch('https://toy-tree-server.vercel.app/category/transformer');
  ...
  const category2 = async (categoryName) => {
    try {
      const res = await fetch(`https://toy-tree-server.vercel.app/category/${categoryName}`);
